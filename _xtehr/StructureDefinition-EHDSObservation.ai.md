# Observation model - EHDS Logical Information Models v1.0.0
...
* Derived from this Logical Model: [Laboratory observation model](StructureDefinition-EHDSLaboratoryObservation.md) and [Observation Obligations](StructureDefinition-EHDSObservationObligations.md)
