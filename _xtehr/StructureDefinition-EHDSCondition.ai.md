# Condition model - EHDS Logical Information Models v1.0.0
...
* Derived from this Logical Model: [Condition laboratory specific obligations](StructureDefinition-EHDSConditionLaboratoryObligations.md) and [Condition obligations](StructureDefinition-EHDSConditionObligations.md)
