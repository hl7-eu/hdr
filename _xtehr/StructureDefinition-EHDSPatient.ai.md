# Patient model - EHDS Logical Information Models v1.0.0
...
* Derived from this Logical Model: [Patient laboratory specific obligations](StructureDefinition-EHDSPatientLaboratoryObligations.md) and [Patient obligations](StructureDefinition-EHDSPatientObligations.md)
