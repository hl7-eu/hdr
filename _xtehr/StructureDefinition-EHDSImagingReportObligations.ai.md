# Imaging Report Obligations - EHDS Logical Information Models v1.0.0

## Logical Model: Imaging Report Obligations 

 
Obligations for the logical model of imaging report. 

**Usages:**

* This Logical Model Profile is not used by any profiles in this Implementation Guide

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/xtehr.eu.ehds.models|current/StructureDefinition/EHDSImagingReportObligations)
...
Other representations of profile: [CSV](../StructureDefinition-EHDSImagingReportObligations.csv), [Excel](../StructureDefinition-EHDSImagingReportObligations.xlsx) 
...
```json
{
  ...
  "id" : "EHDSImagingReportObligations",
  "language" : "en",
  "url" : "http://www.xt-ehr.eu/fhir/models/StructureDefinition/EHDSImagingReportObligations",
  "version" : "1.0.0",
  "name" : "EHDSImagingReportObligations",
  ...
  "baseDefinition" : "http://www.xt-ehr.eu/fhir/models/StructureDefinition/EHDSImagingReport",
  ...
  "differential" : {
    ...
    {
      "id" : "EHDSImagingReport.header.subject",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSImagingReport.header.subject"
    },
    {
      "id" : "EHDSImagingReport.header.identifier",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSImagingReport.header.identifier"
    },
    {
    ...
    {
      "id" : "EHDSImagingReport.header.date",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSImagingReport.header.date"
    },
    {
    ...
    {
      "id" : "EHDSImagingReport.header.language",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSImagingReport.header.language"
    },
    {
    ...
    {
      "id" : "EHDSImagingReport.header.documentTitle",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSImagingReport.header.documentTitle"
    },
    {
      "id" : "EHDSImagingReport.header.period",
      "extension" : [{
        "extension" : [{
          "url" : "code",
      ...
      "path" : "EHDSImagingReport.header.period"
    },
    {
      "id" : "EHDSImagingReport.header.attestation",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSImagingReport.header.attestation"
    },
    {
      "id" : "EHDSImagingReport.header.attestation.attester[x]",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSImagingReport.header.attestation.attester[x]"
    },
    {
      "id" : "EHDSImagingReport.header.attestation.datetime",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSImagingReport.header.attestation.datetime"
    },
    {
      "id" : "EHDSImagingReport.header.legalAuthentication",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSImagingReport.header.legalAuthentication"
    },
    {
      "id" : "EHDSImagingReport.header.legalAuthentication.legalAuthenticator[x]",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSImagingReport.header.legalAuthentication.legalAuthenticator[x]"
    },
    {
      "id" : "EHDSImagingReport.header.legalAuthentication.datetime",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSImagingReport.header.legalAuthentication.datetime"
    },
    {
    ...
    {
      "id" : "EHDSImagingReport.header.serviceSpecialty",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHOULD:process"
      ...
      "path" : "EHDSImagingReport.header.serviceSpecialty"
    },
    {
      "id" : "EHDSImagingReport.header.custodian",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHOULD:able-to-populate"
      ...
      "path" : "EHDSImagingReport.header.custodian"
    },
    {
    ...
    {
      "id" : "EHDSImagingReport.presentedForm",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHOULD:able-to-populate"
      ...
      "path" : "EHDSImagingReport.presentedForm"
    },
    {
