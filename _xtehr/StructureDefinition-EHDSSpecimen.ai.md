# Specimen model - EHDS Logical Information Models v1.0.0
...
* Derived from this Logical Model: [Specimen Obligations](StructureDefinition-EHDSSpecimenLaboratoryObligations.md)
