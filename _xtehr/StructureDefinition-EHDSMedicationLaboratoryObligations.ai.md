# Medication laboratory specific obligations - EHDS Logical Information Models v1.0.0

## Logical Model: Medication laboratory specific obligations 

 
Obligations for the logical model of medication in the scope of laboratory use case 

**Usages:**

* This Logical Model Profile is not used by any profiles in this Implementation Guide

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/xtehr.eu.ehds.models|current/StructureDefinition/EHDSMedicationLaboratoryObligations)
...
Other representations of profile: [CSV](../StructureDefinition-EHDSMedicationLaboratoryObligations.csv), [Excel](../StructureDefinition-EHDSMedicationLaboratoryObligations.xlsx) 
...
```json
{
  ...
  "id" : "EHDSMedicationLaboratoryObligations",
  "language" : "en",
  "url" : "http://www.xt-ehr.eu/fhir/models/StructureDefinition/EHDSMedicationLaboratoryObligations",
  "version" : "1.0.0",
  "name" : "EHDSMedicationLaboratoryObligations",
