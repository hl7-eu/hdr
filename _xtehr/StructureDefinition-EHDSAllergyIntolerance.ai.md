# Allergy intolerance model - EHDS Logical Information Models v1.0.0
...
* Derived from this Logical Model: [AllergyIntolerance obligations](StructureDefinition-EHDSAllergyIntoleranceObligations.md)
