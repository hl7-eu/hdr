# Medication administration model - EHDS Logical Information Models v1.0.0
...
* Derived from this Logical Model: [Medication Administration laboratory specific obligations](StructureDefinition-EHDSMedicationAdministrationLaboratoryObligations.md) and [MedicationAdministration obligations](StructureDefinition-EHDSMedicationAdministrationObligations.md)
