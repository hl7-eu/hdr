# Laboratory report model - EHDS Logical Information Models v1.0.0
...
* Derived from this Logical Model: [Laboratory Report Obligations](StructureDefinition-EHDSLaboratoryReportObligations.md)
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "EHDSLaboratoryReport.header.intendedRecipient[x]",
      "path" : "EHDSLaboratoryReport.header.intendedRecipient[x]",
