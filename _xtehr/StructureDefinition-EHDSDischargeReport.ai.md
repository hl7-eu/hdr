# Discharge Report model - EHDS Logical Information Models v1.0.0
...
* Derived from this Logical Model: [Discharge Report Obligations](StructureDefinition-EHDSDischargeReportObligations.md)
