# Related person model - EHDS Logical Information Models v1.0.0
...
* Derived from this Logical Model: [Related person laboratory specific obligations](StructureDefinition-EHDSRelatedPersonLaboratoryObligations.md) and [Related person obligations](StructureDefinition-EHDSRelatedPersonObligations.md)
