# Imaging study model - EHDS Logical Information Models v1.0.0
...
* Derived from this Logical Model: [Imaging Study Obligations](StructureDefinition-EHDSImagingStudyObligations.md)
