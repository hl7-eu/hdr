# Current pregnancy status model - EHDS Logical Information Models v1.0.0
...
* Derived from this Logical Model: [Current pregnancy obligations](StructureDefinition-EHDSCurrentPregnancyObligations.md)
