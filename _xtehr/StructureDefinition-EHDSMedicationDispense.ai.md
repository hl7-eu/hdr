# Medication dispense model - EHDS Logical Information Models v1.0.0
...
* Derived from this Logical Model: [Medication dispense model obligations](StructureDefinition-EHDSMedicationDispenseObligations.md)
