# Service request model - EHDS Logical Information Models v1.0.0
...
* Derived from this Logical Model: [Service request laboratory specific obligations](StructureDefinition-EHDSServiceRequestLaboratoryObligations.md)
* Use this Logical Model: [Encounter model](StructureDefinition-EHDSEncounter.md), [Imaging study model](StructureDefinition-EHDSImagingStudy.md), [Laboratory report model](StructureDefinition-EHDSLaboratoryReport.md), [Observation model](StructureDefinition-EHDSObservation.md) and [Specimen model](StructureDefinition-EHDSSpecimen.md)
