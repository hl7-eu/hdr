# Device use model - EHDS Logical Information Models v1.0.0
...
* Derived from this Logical Model: [Device use obligations](StructureDefinition-EHDSDeviceUseObligations.md)
