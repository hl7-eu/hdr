# Imaging Study Obligations - EHDS Logical Information Models v1.0.0

## Logical Model: Imaging Study Obligations 

 
Obligations for the logical model of imaging study. 

**Usages:**

* This Logical Model Profile is not used by any profiles in this Implementation Guide

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/xtehr.eu.ehds.models|current/StructureDefinition/EHDSImagingStudyObligations)
...
Other representations of profile: [CSV](../StructureDefinition-EHDSImagingStudyObligations.csv), [Excel](../StructureDefinition-EHDSImagingStudyObligations.xlsx) 
...
```json
{
  ...
  "id" : "EHDSImagingStudyObligations",
  "language" : "en",
  "url" : "http://www.xt-ehr.eu/fhir/models/StructureDefinition/EHDSImagingStudyObligations",
  "version" : "1.0.0",
  "name" : "EHDSImagingStudyObligations",
  ...
  "baseDefinition" : "http://www.xt-ehr.eu/fhir/models/StructureDefinition/EHDSImagingStudy",
