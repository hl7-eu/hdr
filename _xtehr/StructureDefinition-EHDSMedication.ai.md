...
* Derived from this Logical Model: [Medication laboratory specific obligations](StructureDefinition-EHDSMedicationLaboratoryObligations.md) and [Medication model obligations](StructureDefinition-EHDSMedicationObligations.md)
