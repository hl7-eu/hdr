# Imaging report model - EHDS Logical Information Models v1.0.0
...
* Derived from this Logical Model: [Imaging Report Obligations](StructureDefinition-EHDSImagingReportObligations.md)
