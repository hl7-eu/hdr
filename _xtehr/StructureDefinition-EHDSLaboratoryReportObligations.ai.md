# Laboratory Report Obligations - EHDS Logical Information Models v1.0.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/xtehr.eu.ehds.models|current/StructureDefinition/EHDSLaboratoryReportObligations)
...
Other representations of profile: [CSV](../StructureDefinition-EHDSLaboratoryReportObligations.csv), [Excel](../StructureDefinition-EHDSLaboratoryReportObligations.xlsx) 
...
```json
{
  ...
  "id" : "EHDSLaboratoryReportObligations",
  "language" : "en",
  "extension" : [{
    "url" : "http://hl7.org/fhir/StructureDefinition/structuredefinition-type-characteristics",
    "valueCode" : "can-be-target"
  }],
  "url" : "http://www.xt-ehr.eu/fhir/models/StructureDefinition/EHDSLaboratoryReportObligations",
  "version" : "1.0.0",
  "name" : "EHDSLaboratoryReportObligations",
  ...
  "baseDefinition" : "http://www.xt-ehr.eu/fhir/models/StructureDefinition/EHDSLaboratoryReport",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "extension" : [{
        ...
        {
          "url" : "documentation",
          "valueMarkdown" : "Each producer of a laboratory report SHALL be able to provide basic information, such as type of the report, authorship, status of the report, title, etc. This information is crucial for safe identification of the report and for searchability of the report using standardized searching parameters."
        }],
      ...
      },
      {
        ...
        {
          "url" : "documentation",
          "valueMarkdown" : "EHR systems that consume laboratory report SHALL process document header information."
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/obligation"
      }],
    ...
    {
      "id" : "EHDSLaboratoryReport.header.subject",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSLaboratoryReport.header.subject"
    },
    {
      "id" : "EHDSLaboratoryReport.header.identifier",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSLaboratoryReport.header.identifier"
    },
    {
    ...
    {
      "id" : "EHDSLaboratoryReport.header.date",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSLaboratoryReport.header.date"
    },
    {
      "id" : "EHDSLaboratoryReport.header.status",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSLaboratoryReport.header.status"
    },
    {
      "id" : "EHDSLaboratoryReport.header.language",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSLaboratoryReport.header.language"
    },
    {
      "id" : "EHDSLaboratoryReport.header.documentType",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSLaboratoryReport.header.documentType"
    },
    {
      "id" : "EHDSLaboratoryReport.header.documentTitle",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSLaboratoryReport.header.documentTitle"
    },
    {
      "id" : "EHDSLaboratoryReport.header.period",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSLaboratoryReport.header.period"
    },
    {
      "id" : "EHDSLaboratoryReport.header.attestation",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSLaboratoryReport.header.attestation"
    },
    {
    ...
    {
      "id" : "EHDSLaboratoryReport.header.attestation.datetime",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSLaboratoryReport.header.attestation.datetime"
    },
    {
      "id" : "EHDSLaboratoryReport.header.legalAuthentication",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSLaboratoryReport.header.legalAuthentication"
    },
    {
    ...
    {
      "id" : "EHDSLaboratoryReport.header.legalAuthentication.datetime",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSLaboratoryReport.header.legalAuthentication.datetime"
    },
    {
    ...
    {
      "id" : "EHDSLaboratoryReport.header.serviceSpecialty",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSLaboratoryReport.header.serviceSpecialty"
    },
    {
      "id" : "EHDSLaboratoryReport.header.custodian",
      "extension" : [{
        "extension" : [{
          "url" : "code",
          "valueCode" : "SHALL:able-to-populate"
      ...
      "path" : "EHDSLaboratoryReport.header.custodian"
    },
    {
      ...
      "extension" : [{
        ...
        {
          "url" : "documentation",
          "valueMarkdown" : "Each EHR system that is a producer of a laboratory report SHALL be able to provide the entire report as issued by the laboratory in a human readable format, e.g. PDF."
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/obligation"
      },
      {
        ...
        {
          "url" : "documentation",
          "valueMarkdown" : "EHR systems that consume laboratory report SHALL process the human readable version of the report."
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/obligation"
      },
      {
        ...
        {
          "url" : "documentation",
          "valueMarkdown" : "EHR systems that consume laboratory report SHALL render human readable version of the report to the endusers."
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/obligation"
      }],
    ...
    },
    {
      ...
      "extension" : [{
        ...
        {
          "url" : "documentation",
          "valueMarkdown" : "Each EHR system that is a producer of a laboratory report SHALL be able to provide structured information about the laboratory investigation, such as order information, supporting information, specimen details and result data."
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/obligation"
      },
      {
        ...
        {
          "url" : "documentation",
          "valueMarkdown" : "EHR systems that consume laboratory report SHALL process structured body information."
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/obligation"
      }],
    ...
    },
    {
      ...
      "extension" : [{
        ...
        {
          "url" : "documentation",
          "valueMarkdown" : "EHR systems SHALL be able to populate information about one or more order which this report is based on."
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/obligation"
      },
      {
        ...
        {
          "url" : "documentation",
          "valueMarkdown" : "Consumer EHR systems SHALL display key order information to ensure traceability between order and report."
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/obligation"
      }],
    ...
    },
    {
      ...
      },
      {
        ...
        {
          "url" : "documentation",
          "valueMarkdown" : "Consumer systems SHOULD use this element to pair result report with laboratory order. "
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/obligation"
      }],
    ...
    },
    {
      ...
      "extension" : [{
        ...
        {
          "url" : "documentation",
          "valueMarkdown" : "Each EHR system that is a producer of a laboratory report SHOULD be able to provide attachments related to the report, such as documents, diagrams, images of the results, etc."
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/obligation"
      },
      {
        ...
        {
          "url" : "documentation",
          "valueMarkdown" : "EHR systems that consume laboratory report SHOULD process attachments related to the report."
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/obligation"
      },
      {
        ...
        {
          "url" : "documentation",
          "valueMarkdown" : "EHR systems that consume laboratory report SHOULD render attachments related to the report to the endusers."
        }],
        "url" : "http://hl7.org/fhir/StructureDefinition/obligation"
      }],
