...
* details 0..* Base "A.2.9.1.5 - Other details" """Other structured and coded details, care team, goals to be achieved."""
* activity 0..* Base "A.2.9.1.6 - Activity" """Actions to occur as part of the plan."""
...
* activity.attribute 0..* Base "A.2.9.1.6.3 - Specific attributes" """Specific structured attributes per each activity type expressed by the Activity kind element, E.g., specific attributes for prescription request, appointment, etc."""
