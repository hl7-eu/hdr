...
* section[1].title = "Terapia Farmacologica All'Ingresso"
* section[=].code = $sct#1003606003 "Medication history section"
* section[=].text.status = #generated
...
* section[4].title = "Esame Obiettivo"
* section[=].code = $loinc#29545-1 "History general Narrative - Reported"
* section[=].text.status = #generated
...
* section[5].title = "Decorso ospedaliero"
...
* section[6].title = "Condizioni del paziente e diagnosi alla dimissione"
* section[=].code = $loinc#10183-2 "Hospital discharge Dx Narrative"
* section[=].text.status = #generated
* section[=].text.div = """
...
"""
* section[8].title = "Allergie e intolleranze"
* section[=].code = $loinc#48765-2 "Allergy to substance Narrative"
* section[=].text.status = #generated
