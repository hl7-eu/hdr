...
* body 1..1 Base "A.2 - Hospital Discharge Report body data element" """Hospital Discharge Report body data element"""
* body.presentedForm 0..1 Base "A.2.0 - Hospital Discharge Report in its narrative form" """Hospital Discharge Report in its narrative form"""
...
* body.patientHistory 0..1 PatientHistoryEhn "A.2.5 - Hx general Reported" """Hx general Reported (might include information about provenance of the information)"""
...
* body.dischargeDetails 0..1 Base "A.2.7 - Discharge details" """Discharge details (structured information should be provided, however if not available, at least a summary note should be present)."""
...
* body.recommendations 0..1 Base "A.2.8 - Care plan and other recommendations after discharge." """Care plan and other recommendations after discharge."""
