...
Id: PatientHistory
Title: "A.2.5 - Hx general Reported (eHN)"
Description: """Hospital Discharge Report - Hx general Reported - A.2.5 eHN"""
* medicalHistory 1..1 Base "A.2.6.1 - Medical history" """Medical history"""
* medicalHistory.historyOfConditions 1..* Base "A.2.6.1.1 - History of problems" """A list of conditions of a patient that the patient suffered in the past or still suffers. Unlike diagnostic summary, medical history is not only a list of problems, but could contain broader description of the condition and its progress, details about treatment including medication and patient response to treatment. Past problem section (unlike the same section of the patient summary) should include only conditions that are important for continuity of care. This section, if provided, complements the diagnostic summary section of the discharge report."""
...
* medicalHistory.historyOfConditions.conditionDetails 0..* Base "A.2.6.1.1.2 - Problem details" """Problem details include code that identifies problem, specification of the body structure, laterality, and other aspects of the problem."""
...
* medicalHistory.medicalDevices 1..* Base "A.2.6.1.2 - Devices and Implants" """Devices and Implants"""
...
* medicalHistory.historyOfProcedures 0..* Base "A.2.6.1.3 - History of procedures" """Historical procedures performed on or for a patient, relevant for the current encounter."""
...
* medicalHistory.historyOfProcedures.focalDevice 0..* Base "A.2.6.1.3.7 - Focal device" """A reference to the device or devices that is implanted, removed or otherwise manipulated (calibration, battery replacement, fitting a prosthesis, attaching a wound-vac, etc.) as a focal portion of the Procedure."""
* medicalHistory.vaccination 0..* Base "A.2.6.1.4 - Vaccination" """Vaccination history of the patient."""
...
* medicalHistory.vaccination.manufacturerOrMAH 0..1 Base "A.2.6.1.4.5 - Marketing Authorisation Holder" """Marketing Authorisation Holder or manufacturer (Identifier and name)"""
...
* medicalHistory.epidemiologicalHistory 0..1 Base "A.2.6.1.5 - Epidemiological history" """Travel history and infectious contacts"""
* medicalHistory.epidemiologicalHistory.infectiousContacts 0..* Base "A.2.6.1.5.1 - Infectious contacts" """Infectious contacts of the patient"""
...
* medicalHistory.epidemiologicalHistory.travelHistory 0..* Base "A.2.6.1.5.2 - Travel history" """Travel history reported by the patient. Multiple records could be provided."""
...
* familyHistory 0..* Base "A.2.6.2 - Family history" """Information about serious illnesses in close blood relatives with known or suspected genetic potential or with possible impact on patient care."""
...
* familyHistory.deathDateOrAge 0..1 Base "A.2.6.2.3 - Age or date of death" """Age or date of the death of the family member."""
* familyHistory.conditions 0..* Base "A.2.6.2.5 - Condition" """Medical problems this person suffers or suffered."""
...
* socialDeterminants 0..1 Base "A.2.6.3 - Social determinants of health" """Information about social determinants of health."""
* socialDeterminants.participationInSociety 0..1 Base "A.2.6.3.1 - Participation in society" """Participation in society details."""
...
* socialDeterminants.education 0..1 Base "A.2.6.3.2 - Education" """Education"""
...
* socialDeterminants.livingSituation 0..1 Base "A.2.6.3.3 - Living situation" """Household type and other related living situation information."""
...
* socialDeterminants.familySituation 0..1 Base "A.2.6.3.4 - Family situation" """Family situation details."""
...
* socialDeterminants.familySituation.childDetails 0..* Base "A.2.6.3.4.6 - Child details" """Child age, co-living status and comment. Multiple child details could be provided."""
* socialDeterminants.familySituation.careResponsibility 0..* Base "A.2.6.3.4.7 - Care responsibility" """The activities the patient carries out to care for a dependent family member."""
* useOfSubstances 0..1 Base "A.2.6.4 - Use of substances" """Use of substances"""
* useOfSubstances.alcohol 0..* Base "A.2.6.4.1 - Alcohol use" """Alcohol consumption by the patient. Multiple records on alcohol use could be provided."""
...
* useOfSubstances.tobacco 0..* Base "A.2.6.4.2 - Tobacco use" """Represent smoking or tobacco habits. Multiple records on tobacco use could be provided."""
* useOfSubstances.tobacco.currentStatus 0..1 CodeableConcept "A.2.6.4.2.1 - Status" """The status of the patient’s tobacco use."""
* useOfSubstances.tobacco.periodAndQuantity 0..* Base "A.2.6.4.2.2 - Period and quantity" """Period of use and amount (The extent of the patient’s tobacco use in units of alcohol per time period.)"""
* useOfSubstances.tobacco.comment 0..1 string "A.2.6.4.2.3 - Comment" """Textual comment."""
* useOfSubstances.drugConsumption 0..* Base "A.2.6.4.3 - Drug consumption" """Consumption of drugs and other substances (in terms of abuse)."""
...
* useOfSubstances.drugConsumption.periodAndQuantity 0..1 Base "A.2.6.4.3.2 - Period and quantity" """Period of use and amount."""
