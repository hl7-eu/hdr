...
* livingWill 1..* Base "A.2.1.1 - Living will" """Only directives being expressed during current inpatient stay. Multiple records of living wills could be provided."""
...
* livingWill.document 1..1 Base "A.2.1.1.5 - Living will document" """Scanned source document with the living will and the patient's signature, such as a PDF."""
