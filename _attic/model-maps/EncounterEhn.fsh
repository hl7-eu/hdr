...
* admission 1..1 Base "A.2.3.3 - Admission" """Admission"""
...
* admission.admitter 0..1 Base "Admitting professional" """Admitting Healthcare Professional"""
...
* admission.admitter.organization 0..1 Base "A.2.3.3.6 - Admitting organisation" """The healthcare provider organisation information."""
...
* admission.referringHP 0..1 Base "Referring professional" """Referring Healthcare Professional"""
...
* admission.referringHP.organization 0..1 Base "A.2.3.3.11 - Referring organisation" """The healthcare provider organisation information."""
* admissionReason 1..1 Base "A.2.3.4 - Admission reason" """Admission reason"""
...
* discharge 1..1 Base "A.2.3.5 - Discharge" """Discharge"""
...
* location 0..* Base "A.2.3.6 - Location - All locations/departments where the patient stayed (was boarded) within the hospital." """Location - All locations/departments where the patient stayed (was boarded) within the hospital."""
* location.period 1..1 Period "A.2.3.6.1 - Period" """Time period during which the patient was present at the location"""
* location.organization 1..1 Base "Organization" """Organization or organization part (hospital department) where the patient was present."""
